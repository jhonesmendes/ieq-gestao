...
export function SimpleAppLayout() {
  ...
  return (
    <div className="bg-slate mx-auto flex h-dvh max-w-[480px] flex-col overflow-hidden">
      <header className="bg-ink flex-shrink-0 px-5 pt-[calc(16px+env(safe-area-inset-top))] pb-5 text-white">
      ...
      <nav className="bg-card border-border flex flex-shrink-0 border-t px-1 py-2 pb-[calc(8px+env(safe-area-inset-bottom))]">
        {abas.map((aba) => (
          <NavLink
            key={aba.to}
            to={aba.to}
